var SubscriptionsTransportWs = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ [
      ...
      /* WEBPACK VAR INJECTION */ (function(global, process) {
        ...
        var SubscriptionClient = (function() {
          ...
          SubscriptionClient.prototype.close = function(
            ...
            if (this.client !== null) {
              ...
              if (isForced) {
                ...
                this.sendMessage(
                  undefined,
                  message_types_1.default.GQL_CONNECTION_TERMINATE,
                  null
                );
              }
              this.client.close();
          ...
          SubscriptionClient.prototype.onConnect = function(callback, context) {
            this.logWarningOnNonProductionEnv(
              "This method will become deprecated in the next release. " +
          ...
          SubscriptionClient.prototype.onReconnect = function(
            callback,
            context
          ) {
            this.logWarningOnNonProductionEnv(
          ...
          SubscriptionClient.prototype.onConnected = function(
            callback,
            context
          ) {
            return this.on("connected", callback, context);
          };
          SubscriptionClient.prototype.onConnecting = function(
            callback,
            context
          ) {
          ...
          SubscriptionClient.prototype.unsubscribe = function(opId) {
            if (this.operations[opId]) {
              ...
              this.sendMessage(
                opId,
                message_types_1.default.GQL_STOP,
                undefined
              );
            }
          };
            ...
            this.applyMiddlewares(options)
              .then(function(processedOptions) {
                ...
                if (_this.operations[opId]) {
                  ...
                  _this.sendMessage(
                    opId,
                    message_types_1.default.GQL_START,
                    processedOptions
                  );
                }
              })
          ...
          SubscriptionClient.prototype.logWarningOnNonProductionEnv = function(
            warning
          ) {
            if (
              process &&
          ...
          SubscriptionClient.prototype.buildMessage = function(
            id,
            type,
            payload
          ) {
          ...
          SubscriptionClient.prototype.sendMessage = function(
            id,
            type,
            payload
          ) {
          ...
          SubscriptionClient.prototype.connect = function() {
            ...
            this.client.onopen = function() {
              ...
              _this.eventEmitter.emit(
                _this.reconnecting ? "reconnecting" : "connecting"
              );
              var payload =
                typeof _this.connectionParams === "function"
            ...
            switch (parsedMessage.type) {
              ...
              case message_types_1.default.GQL_DATA:
                var parsedPayload = !parsedMessage.payload.errors
                  ...
                  : __assign({}, parsedMessage.payload, {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var OPERATION_DEFINITION = (exports.OPERATION_DEFINITION =
        "OperationDefinition");
      var VARIABLE_DEFINITION = (exports.VARIABLE_DEFINITION =
        "VariableDefinition");
      ...
      var FRAGMENT_DEFINITION = (exports.FRAGMENT_DEFINITION =
        "FragmentDefinition");
      ...
      var OPERATION_TYPE_DEFINITION = (exports.OPERATION_TYPE_DEFINITION =
        "OperationTypeDefinition");

      // Type Definitions

      var SCALAR_TYPE_DEFINITION = (exports.SCALAR_TYPE_DEFINITION =
        "ScalarTypeDefinition");
      var OBJECT_TYPE_DEFINITION = (exports.OBJECT_TYPE_DEFINITION =
        "ObjectTypeDefinition");
      var FIELD_DEFINITION = (exports.FIELD_DEFINITION = "FieldDefinition");
      var INPUT_VALUE_DEFINITION = (exports.INPUT_VALUE_DEFINITION =
        "InputValueDefinition");
      var INTERFACE_TYPE_DEFINITION = (exports.INTERFACE_TYPE_DEFINITION =
        "InterfaceTypeDefinition");
      var UNION_TYPE_DEFINITION = (exports.UNION_TYPE_DEFINITION =
        "UnionTypeDefinition");
      var ENUM_TYPE_DEFINITION = (exports.ENUM_TYPE_DEFINITION =
        "EnumTypeDefinition");
      var ENUM_VALUE_DEFINITION = (exports.ENUM_VALUE_DEFINITION =
        "EnumValueDefinition");
      var INPUT_OBJECT_TYPE_DEFINITION = (exports.INPUT_OBJECT_TYPE_DEFINITION =
        "InputObjectTypeDefinition");

      // Type Extensions

      var TYPE_EXTENSION_DEFINITION = (exports.TYPE_EXTENSION_DEFINITION =
      ...
      /* WEBPACK VAR INJECTION */ (function(process) {
        ...
        function addGraphQLSubscriptions(networkInterface, wsClient) {
          if (process && process.env && process.env.NODE_ENV !== "production") {
            console.warn(
              "Notice that addGraphQLSubscriptions method will become deprecated in the new package " +
